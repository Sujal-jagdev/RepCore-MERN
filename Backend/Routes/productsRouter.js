...
const { createPost, getAllProducts, getWomensProducts, deleteproduct, GetOneProduct, AddToCart, GetAddedCartProduct } = require("../Controllers/Product");
...
productRouter.post("/user/getproduct",isLoggedIn,GetAddedCartProduct)
